...
|                          | `Ctrl+Z`                   | Undo the last editor step. A whole typing run and a whole drag each count as one step, selecting something is a step of its own, and it also fires while the map has focus. |
