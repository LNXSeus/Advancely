...
* **Compact Mode**: The `Row 1 Icons` section at the top can show the first-row icons (advancement criteria and
  ...
  `Shared Icon Size`). `Fade Out` fades a line out when it leaves the stack instead of removing it instantly, with the
