...
* **Overlay Mode**: Pick `Scrolling Belt` (the classic scrolling conveyor) or `Page` (a static, centered page of items
  that cuts to the next page like a book). `Page` mode reveals its own `Page Switch Interval`, `Repeat To Fill Page`,
  and `Page Alignment` options.
...
| Aesthetics                                    | Customize the `Overlay Font`, `Overlay Background Color`, and `Overlay Text Color`. Set the `Top Text Size` (top info bar) and `Row Text Size` (row 2 and 3 item text) independently. A larger font or text size increases the overlay window height to fit the taller text.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Co-op**                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
> the [template editor](#the-template-editor-esc--edit-templates) opens this folder.
</details>
