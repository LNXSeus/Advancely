...
* **Overlay Mode**: Pick `Scrolling Belt` (the classic scrolling conveyor), `Page` (a static, centered page of items
  ...
  it). `Page` mode reveals its own `Page Switch Interval`, `Repeat To Fill Page`, and `Page Alignment` options.
