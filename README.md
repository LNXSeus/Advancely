...
* **SpeedrunIGT Accurate IGT**: When the [SpeedrunIGT mod](https://github.com/RedLime/SpeedRunIGT) is installed, the
  ...
  millisecond. The mod's timer can of course stop before the tracked template is complete, if its category isn't the
